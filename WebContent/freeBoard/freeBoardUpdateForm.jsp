   ...
   <nav style="margin-top: 20px;">
	...
	<h1>게시글 수정</h1>
		...
		<table class="table table-condensed">
			<tr>
				<th>글쓴이</th>
				<td><input type="text" name="createName" value="${freeBoard.createName}" readonly="readonly">* 필수 </td>
			</tr>
			...
			<tr>
				<th>내용</th>
				<td><textarea rows="15" cols="70" name="conValue">${freeBoard.conValue}</textarea>* 필수 </td>
