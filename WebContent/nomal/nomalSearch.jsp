...
<div class="container">
   ...
   <nav style="margin-top: 20px;">
	...
	<span onclick="location.href='nomalSearch.do'" style="font-weight: bold;">구인자 검색</span></div>
<div class="contents_top2" style="padding-top: 10px">
	...
	<div class="contents_top2_2">
		<input type="button" class="btn btn-primary" value="구직등록하기" onclick="location.href='nomalWriteForm.do'">
	</div>
</div>
...
<form action="nomalSearch.do" id="formTest" name="area" method="post"> 
...
<table class="table">
	...
	<tbody>
		<c:forEach items="${comBoard}" var="c" varStatus="r">
			<tr>
				<td><a href="comView2.do?cnum=${c.cnum}">${c.ctitle}</a></td>
				<td>${c.cjob}</td>
				<td>${c.ccarrer}</td>
				<td>${c.carea}</td>
